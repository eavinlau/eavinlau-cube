...
var ELCubeHeatMapRender = function (jqContainer, options, isDeepSpec) {
...
ELCubeHeatMapRender.prototype.theme = "theme-fin1"; // 主题

ELCubeHeatMapRender.prototype.chart = function (group, persist) {
    var self = this;
...
ELCubeHeatMapRender.prototype.changeSize = function (instance) {
