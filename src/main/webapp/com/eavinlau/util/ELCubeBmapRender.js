...
var ELCubeBMapRender = function (jqContainer, options, isDeepSpec) {
...
ELCubeBMapRender.prototype.theme = "theme-fin1"; // 主题

ELCubeBMapRender.prototype.chart = function (group, persist) {
    var self = this;
...
ELCubeBMapRender.prototype.changeSize = function (instance) {
