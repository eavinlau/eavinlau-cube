...
var ELCubeEChartRender = function (jqContainer, options, isDeepSpec) {
...
ELCubeEChartRender.prototype.theme = "theme-fin1"; // 主题

ELCubeEChartRender.prototype.chart = function (group, persist) {
    var self = this;
...
ELCubeEChartRender.prototype.changeSize = function (instance) {
...
ELCubeEChartRender.prototype.addClick = function (chartConfig, relations, $state, $window) {
