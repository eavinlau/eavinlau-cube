var ELCubeTableRender = function (jqContainer, options, drill) {
...
ELCubeTableRender.prototype.resize = function (container) {
...
ELCubeTableRender.prototype.do = function (tall, persist) {
    this.tall = tall;
