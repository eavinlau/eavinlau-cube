 ...
 */
'use strict';
elCube.service('chartService', function($q, dataService, chartPieService, chartLineService, chartFunnelService,
  ...
  this.render = function(containerDom, widget, optionFilter, scope, reload, persist, relations, isCockpit) {
      if (isCockpit) {
          ELCubeEChartRender.prototype.theme = "dark";
      } else {
          ELCubeEChartRender.prototype.theme = "theme-fin1"
      }
  ...
  var getChartServices = function(chartConfig) {
    console.log(chartConfig, "chartConfig-000")
    var chart;
