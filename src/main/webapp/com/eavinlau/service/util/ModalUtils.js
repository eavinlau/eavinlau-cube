...
elCube.service('ModalUtils', function ($uibModal, $filter) {

    var translate = $filter('translate');

    this.alert = function (content, style, size, callback) {
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/util/modal/alert.html',
    ...
    this.confirm = function (content, style, size, ok, close) {
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/util/modal/confirm.html',
            windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
            backdrop: false,
            windowClass: style,
            size: size,
    ...
    this.info = function (content, style, size, ok, close) {
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/util/modal/information.html',
            windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
            backdrop: false,
            windowClass: style,
            size: size,
