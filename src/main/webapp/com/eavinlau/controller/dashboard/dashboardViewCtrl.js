...
elCube.controller('dashboardViewCtrl', function ($timeout, $rootScope, $scope, $state, $stateParams, $http, ModalUtils, chartService, $interval, $uibModal, dataService) {
    ...
    $scope.modalChart = function (widget) {
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/util/modal/chart.html',
    ...
    $scope.toCockpitView = function (param) {
        ...
        window.open('render.html?sid=elcube#?id=' + $stateParams.id, '', winInfo)
    };
            ...
            _.each(row.params, function (param) {
                ...
                switch (param.type) {
                    ...
                    case '[a,b]':
                        ...
                        paramObj = param.name + ' = ' + leftBrackets + param.values[0] + ',' + param.values[1] + rightBrackets;
                        break;
                }
