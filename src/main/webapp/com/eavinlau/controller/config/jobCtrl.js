 ...
 */
elCube.controller('jobCtrl', function ($scope, $rootScope, $http, dataService, $uibModal, ModalUtils, $filter, $interval) {
    var translate = $filter('translate');

    $scope.jobTypes = [{name: '发送邮件', type: 'mail'}];
    ...
    $scope.editJob = function (job) {
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/config/modal/job/edit.html',
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.config = function () {
                    $uibModal.open({
                        templateUrl: 'com/eavinlau/view/config/modal/job/' + $scope.job.jobType + '.html',
                        windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
                        backdrop: false,
                        size: 'lg',
                        scope: $scope,
