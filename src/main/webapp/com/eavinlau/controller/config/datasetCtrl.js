 ...
 */
elCube.controller('datasetCtrl', function ($scope, $http, $state, $stateParams, dataService, $uibModal, ModalUtils, $filter, chartService, $timeout, uuid4) {
    ...
    $scope.custom = function (o) {
        ...
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/config/modal/custom.html',
            windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
            backdrop: false,
            size: 'lg',
            controller: function ($scope, $uibModalInstance) {
