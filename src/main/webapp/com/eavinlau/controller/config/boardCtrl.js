...
elCube.controller('boardCtrl',
    function ($rootScope, $scope, $http, ModalUtils, $filter, updateService, $uibModal,
        ...
        $scope.editParam = function (row, index) {
            ...
            $uibModal.open({
                templateUrl: 'com/eavinlau/view/config/board/modal/param.html',
                ...
                controller: function ($scope, $uibModalInstance) {
                    $scope.param_types = [
                        ...
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_SINGLE'), value: 'single'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_MULTIPLE'), value: 'multiple'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATESINGLEPICKER'), value: 'datesinglepicker'},
                        {name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATERANGEPICKER'), value: 'daterangepicker'},
