 ...
 */
elCube.controller('datasourceCtrl', function ($scope, $state, $stateParams, $http, ModalUtils, $uibModal, $filter, $q) {
    ...
    $scope.test = function () {
        ...
        $uibModal.open({
            templateUrl: 'com/eavinlau/view/config/modal/test.html',
