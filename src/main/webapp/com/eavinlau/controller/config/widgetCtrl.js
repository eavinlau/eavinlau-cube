 ...
 */
'use strict';
elCube.controller('widgetCtrl', function ($scope, $state, $stateParams, $http, $uibModal, dataService, ModalUtils, updateService, $filter, chartService, $timeout) {
        ...
        $scope.kpi_styles = [
            ...
            {name: "纯文本", value: 'bg-tt'},
            {name: "紫棠", value: 'bg_bg1'},
            {name: "雪青", value: 'bg_bg2'},
            {name: "碧蓝", value: 'bg_bg3'},
            {name: "玉色", value: 'bg_bg4'},
            {name: "青碧", value: 'bg_bg5'},
            {name: "绿沈", value: 'bg_bg6'},
            {name: "豆青", value: 'bg_bg7'},
            {name: "黛蓝", value: 'bg_bg8'},
            {name: "青莲", value: 'bg_bg9'},
            {name: "樱草", value: 'bg_bg10'},
        ];
        ...
        $scope.editExp = function (col) {
            ...
            $uibModal.open({
                templateUrl: 'com/eavinlau/view/config/modal/exp.html',
...
// };
        ...
        $scope.getChartView = function () {
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
                return 'com/eavinlau/view/config/chart/' + $scope.curWidget.config.chart_type + '.html';
            }
        };

        $scope.getOptionsView = function () {
            var basePath = 'com/eavinlau/view/config/chart/options/';
            if ($scope.curWidget.config && $scope.curWidget.config.chart_type) {
        ...
        $scope.editVFilter = function (o) {
            $uibModal.open({
                templateUrl: 'com/eavinlau/view/config/modal/vfilter.html',
                windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
                backdrop: false,
                size: 'lg',
                controller: function ($scope, $uibModalInstance) {
        ...
        $scope.editFilterGroup = function (col) {
            var columnObjs = schemaToSelect($scope.schema);
            $uibModal.open({
                templateUrl: 'com/eavinlau/view/config/modal/filterGroup.html',
                windowTemplateUrl: 'com/eavinlau/view/util/modal/window.html',
                backdrop: false,
                scope: $scope,
                controller: function ($scope, $uibModalInstance) {
