package com.eavinlau.cube.jdbc;
...
import com.eavinlau.cube.dataprovider.util.SqlHelper;
        ...
        try (Connection con = getConnection();
            ...
            while (rs.next()) {
                ...
                if (resultCount > resultLimit) {
                    throw new AJCubeException("Cube result count " + resultCount + ", is greater than limit " + resultLimit);
                }
            }
            executor.shutdown();
