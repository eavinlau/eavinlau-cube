package com.eavinlau.cube.kylin.model;

import com.alibaba.fastjson.JSONObject;
import org.apache.commons.collections.map.HashedMap;
import com.eavinlau.cube.exception.AJCubeException;
import com.eavinlau.cube.kylin.KylinDataProvider;
import com.eavinlau.cube.kylin.TableMap;
...
public abstract class KylinBaseModel implements Serializable {
    ...
    public KylinBaseModel(JSONObject model, Map<String, String> dataSource, Map<String, String> query, String[] version) throws Exception {
        if (model == null) {
            throw new AJCubeException("Model not found");
        }
